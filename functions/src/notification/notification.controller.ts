...
export class NotificationController {
	...
	async sendPushNotification(
		@Body() singleNotificationRequest: SingleNotificationRequestDto
	) {
		return await this.notificationService.sendSinglePushNotification(
	...
	async subscribeToTopic(
		@Body() subscribeToTopicRequest: SubscribeToTopicRequestDto
	) {
		return await this.notificationService.subscribeToNotificationTopic(
	...
	async sendNotificationToAll(
		@Body() sendNotificationToAllRequest: SendNotificationToAllRequestDto
	) {
		...
		return await this.notificationService.sendGroupPushNotification(
