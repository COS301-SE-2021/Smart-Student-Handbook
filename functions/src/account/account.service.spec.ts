...
// 						email: 'email.sd@test.com',
// 						password: 'password',
// 						displayName: 'password',
// 					};
//
// 					it('should throw "Invalid data"', () => {
// 						console.log(service.registerUser((admin)(userDto));
// 						// expect(() => service.registerUser(userDto)()).toEqual();
// 						// expect(() => registerUser(admin)(data1)).toThrow();
// 						// expect(() => registerUser(admin)(data2)).toThrow();
// 						// expect(() => registerUser(admin)(data3)).toThrow(Errors.INVALID_DATA);
// 						// expect(() => registerUser(admin)(data4)).toThrow(Errors.INVALID_DATA);
// 					});
// 				});
// 			});
// 		});
